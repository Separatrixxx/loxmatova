        ...
        <div className="scroll-smooth bg-white">
            <div id="first_div" className="flex flex-col lg:flex-row w-full bg-neutral-800" onTouchStart={closeMenu}>
                <div className="w-full lg:w-1/2 bg-white p-10 lg:p-20 pt-20">
                    <div>
                        <h1 className="text-violet text-2xl lg:text-3xl _anim-items _anim-no-hide contacts_1">Свяжитесь со мной</h1>
                        <p className="text-lg lg:text-xl text-neutral-800 mt-3 _anim-items _anim-no-hide contacts_2">Если у вас появились вопросы, или вы хотите заказать фотосессию, пишите в социальных сетях</p>
                        <div className="flex w-full justify-center mt-7 _anim-items _anim-no-hide contacts_3">
                        ...
                        <p className="text-lg lg:text-xl mt-7 _anim-items _anim-no-hide contacts_4">Или отправьте сообщение через форму:</p>
                        <ContactForm />
                    </div>
                </div>
