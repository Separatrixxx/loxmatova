...
function ContactForm() {
    return(
        <div className="flex mt-7">
            <div>
                <div className="flex flex-col contacts_5">
                ...
                <div className="flex flex-col mt-3 contacts_6">
                ...
                <div className="flex flex-col mt-3 contacts_7">
